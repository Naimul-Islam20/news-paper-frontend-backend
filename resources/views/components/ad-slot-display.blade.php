...
@if($showLocal)
@if($isStrip)
<div class="{{ $stripOuterClass }} {{ $wrapperClass }}" data-ad-slot-root @if($isBelowMenu) data-ad-below-menu @endif @if($variant==='header' ) id="header-ad-slot" @endif>
    <div class="container">
...
@elseif($showGoogle)
@if($isStrip)
<div class="{{ $stripOuterClass }} {{ $wrapperClass }}" data-ad-slot-root data-ad-google @if($isBelowMenu) data-ad-below-menu @endif @if($variant==='header' ) id="header-ad-slot" @endif>
    <div class="container">
        <x-google-ad-unit :ad="$ad" :layout="$isStrip ? 'strip' : 'box'" />
    </div>
</div>
@elseif($variant === 'sidebar')
