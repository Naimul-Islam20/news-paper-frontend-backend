<div
    ...
    class="inline notranslate {{ $attributes->get('class') }}">
    <button
        type="button"
        @click="toggleLang()"
        class="inline p-0 m-0 bg-transparent border-0 font-medium text-inherit hover:text-primary transition-colors cursor-pointer"
