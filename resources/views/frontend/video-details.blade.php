        ...
        <div class="container">
            ...
            <section class="details-grid">
                ...
                <div class="flex flex-col gap-10 w-full">
                    ...
                    <!-- বিজ্ঞাপন -->
                    <div class="w-full bg-slate-50 border border-slate-100 relative h-[400px] flex flex-col">
                        <span class="text-[10px] uppercase font-bold text-slate-400 p-2 block text-center border-b border-slate-100">বিজ্ঞাপন</span>
                        <div class="flex-1 flex items-center justify-center text-slate-300 font-bold italic text-sm">
                            বিজ্ঞাপন
                        </div>
                    </div>
