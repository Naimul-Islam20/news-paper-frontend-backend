            ...
            <div class="container">
                ...
                <section class="national-grid">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="block overflow-hidden border border-slate-200 shadow-sm">
                            <div class="relative h-[250px] w-full bg-gradient-to-br from-[#1e3a5f] to-[#0f172a] flex flex-col items-center justify-center p-8 text-center overflow-hidden">
                                <div class="absolute inset-0 opacity-10 pointer-events-none">
                                    <svg width="100%" height="100%"><pattern id="pattern-cat-gal" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse"><circle cx="2" cy="2" r="1" fill="white"/></pattern><rect width="100%" height="100%" fill="url(#pattern-cat-gal)"/></svg>
                                </div>
                                <h4 class="text-white font-bold text-xl leading-tight mb-4 relative z-10">আপনার ব্যবসার প্রসারে<br>আমাদের সাথে নামুন</h4>
                                <a href="#" class="px-6 py-2.5 bg-rose-600 text-white text-sm font-bold hover:bg-rose-700 transition-all shadow-xl relative z-10">বিজ্ঞাপন দিন →</a>
                            </div>
                        </div>
                        <div class="block overflow-hidden border border-slate-200 shadow-sm mt-4">
                            <div class="relative h-[180px] w-full bg-gradient-to-br from-[#7c3aed] to-[#4338ca] flex flex-col items-center justify-center p-6 text-center overflow-hidden">
                                ...
                                <span class="px-4 py-1.5 bg-white/20 text-white text-[11px] font-bold border border-white/30">বিস্তারিত দেখুন</span>
                            </div>
                        </div>
                    </div>
                </section>
