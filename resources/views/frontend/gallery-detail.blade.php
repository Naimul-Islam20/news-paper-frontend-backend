                ...
                <div class="flex flex-col gap-6 w-full">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-sm text-slate-500 italic border-l-4 border-rose-600 py-1 bg-slate-50 pl-3">
                                {{ $image->description }}
                            </p>
                            @endif
                        </div>
                    ...
                    <div class="w-full bg-slate-50 overflow-hidden border border-slate-100 shadow-sm">
                        ...
                        <a href="#" class="block hover:opacity-95 transition-opacity">
                            <div class="relative h-[250px] w-full bg-gradient-to-br from-[#1e3a5f] to-[#0f172a] flex flex-col items-center justify-center p-8 text-center">
                                <h4 class="text-white font-bold text-xl leading-tight mb-4">আপনার ব্যবসার প্রসারে আমাদের সাথে নামুন</h4>
                                <span class="px-6 py-2 bg-rose-600 text-white text-sm font-bold">বিজ্ঞাপন দিন →</span>
                            </div>
                        </a>
                    </div>
