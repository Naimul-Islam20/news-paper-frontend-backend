...
<x-layout>
    <x-slot:title>{{ $postShareTitle }}</x-slot>
        ...
        @if($adDetailsBelowMenu && $adDetailsBelowMenu->image)
                        ...
                        <div class="container">
                            ...
                            <section class="details-grid">
                                ...
                                <div class="flex flex-col gap-6 w-full">
                                    ...
                                    $hasDetailsRightAds = ($adDetailsRight1 && $adDetailsRight1->image)
                                    || ($adDetailsRight2 && $adDetailsRight2->image);

                                    $descRaw = $post->description ?? '';
                                    $mobileAd1 = ($adDetailsRight1 && $adDetailsRight1->image)
                                        ? view('frontend.partials.detail-inline-ad', ['ad' => $adDetailsRight1])->render()
                                        : '';
                                    $mobileAd2 = ($adDetailsRight2 && $adDetailsRight2->image)
                                ...
                                <div class="hidden lg:flex flex-col gap-10 w-full min-w-0">
                                    ...
                                    <div class="flex flex-col gap-4 w-full min-w-0 ad-section">
                                        @if($adDetailsRight1 && $adDetailsRight1->image)
                                        ...
                                        @endif
                                        @if($adDetailsRight2 && $adDetailsRight2->image)
                                        <div class="shrink-0 w-full">
