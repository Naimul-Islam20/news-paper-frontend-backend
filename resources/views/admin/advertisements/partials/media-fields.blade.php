...
<div class="space-y-4">
    ...
    <div id="{{ $idPrefix }}media-image" class="ad-media-panel space-y-4 {{ $mediaType !== 'image' ? 'hidden' : '' }}">
        <div>
            <label for="{{ $idPrefix }}caption" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">ক্যাপশন</label>
        ...
        <div>
            <label for="{{ $idPrefix }}image_mobile" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">মোবাইল ইমেজ</label>
    ...
    <div id="{{ $idPrefix }}media-video" class="ad-media-panel space-y-4 {{ $mediaType !== 'video' ? 'hidden' : '' }}">
        ...
        <div>
            <label for="{{ $idPrefix }}video_mobile" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">মোবাইল ভিডিও</label>
