                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-8 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="sub_title" rows="3" placeholder="সাবটাইটেল ২–৩ লাইন লিখুন..." class="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-800 focus:ring-1 focus:ring-indigo-500 transition-all outline-none font-normal text-slate-900 text-sm resize-y min-h-[4.5rem]">{{ old('sub_title', $post->sub_title) }}</textarea>
