                            ...
                            <div class="rounded-lg border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/30 divide-y divide-slate-100 dark:divide-slate-800">
                                ...
                                <div class="flex items-center justify-between px-4 py-3">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="main_section_layer" value="{{ $layer['value'] }}" {{ old('main_section_layer', $post->main_section_layer) == $layer['value'] ? 'checked' : '' }} class="sr-only peer layer-checkbox">
